...
export default function TermsOfService() {
  return (
    <div className="min-h-screen bg-night text-night-text py-12 pt-24">
        ...
        <div className="bg-night-card rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">1. Acceptance of Terms</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">2. Description of Service</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">3. User Accounts</h2>
              <p className="text-night-text-secondary mb-4">
                To use certain features of the App, you may be required to create an account. You are responsible for:
              </p>
              <ul className="list-disc pl-6 text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">4. Acceptable Use</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">5. Health and Wellness Disclaimer</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">6. Intellectual Property</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">7. User-Generated Content</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">8. Privacy</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">9. Subscription and Payments</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">10. Limitation of Liability</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">11. Disclaimer of Warranties</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">12. Termination</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">13. Changes to Terms</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">14. Governing Law</h2>
              <p className="text-night-text-secondary mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-night-text mb-4">15. Contact Information</h2>
              <p className="text-night-text-secondary mb-4">
                If you have any questions about these Terms of Service, please contact us:
              </p>
              <ul className="list-none text-night-text-secondary">
